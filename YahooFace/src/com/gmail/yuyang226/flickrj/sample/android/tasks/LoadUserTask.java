...
public class LoadUserTask extends AsyncTask<OAuth, Void, User> {
	 ...
	 * 
	 */
	private final YahooCameraActivity flickrjAndroidSampleActivity;
	private ImageView userIconImage;
	private final Logger logger = LoggerFactory.getLogger(LoadUserTask.class);
	
	public LoadUserTask(YahooCameraActivity yahooCameraActivity, 
			ImageView userIconImage) {
		this.flickrjAndroidSampleActivity = yahooCameraActivity;
