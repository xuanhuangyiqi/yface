...
public class LoaderAdapterForShare extends BaseAdapter{
	...
	public LoaderAdapterForShare(int count, Context context, String []url) {
		this.mCount = count;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.list_itemforshare, null);
			viewHolder = new ViewHolder();
			viewHolder.mTextView = (TextView) convertView
					.findViewById(R.id.item_tips1);
