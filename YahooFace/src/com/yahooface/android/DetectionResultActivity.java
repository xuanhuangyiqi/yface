 ...
 *  sina weibo account ：android火星人
 *  android  develop group ：200102476
 */

public class DetectionResultActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detectionresult);
	...
	@Override
	 public boolean onKeyDown(int keyCode, KeyEvent event) {
	        if(keyCode==KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0){
	            Intent intent = new Intent(DetectionResultActivity.this,CameraActivity.class);
	...
	private void setupViews() {
		...
		adapter = new LoaderAdapter(Account.list.size(), this, URLS);
		...
		mListview.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
				 //获得选中项的HashMap对象                 
				Account.curPerson = Account.list.get(arg2); 
				Intent intent = new Intent(DetectionResultActivity.this,PersonActivity.class);
				startActivity(intent);
